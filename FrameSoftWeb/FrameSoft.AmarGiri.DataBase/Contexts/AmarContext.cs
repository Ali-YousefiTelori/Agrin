...
namespace FrameSoft.AmarGiri.DataBase.Contexts
{
    public class AmarContext : DbContext
    {
        ...
        //}
        public AmarContext()
              : base("data source=(LOCAL)\\SQLEXPRESS;initial catalog=FrameSoftAmar;User ID=Ali;Password=AVS?3773284HAMISHEBAHAR?2354;App=EntityFramework")
        {
        ...
        //public AmarContext()
        //    : base("Data Source=(local);Initial Catalog=FrameSoftAmar;User ID=Ali;Password=AVS?3773284HAMISHEBAHAR?2354")
        //{
        //}
        //public AmarContext()
        //    : base("Data Source=82.102.13.99;Initial Catalog=FrameSoftAmar;User ID=Ali;Password=AVS?3773284HAMISHEBAHAR?2354")
        //{
        //}
#elif (FrameSoftIR)
 public AmarContext()
            : base("Data Source=localhost;Integrated Security=False;Initial Catalog=FrameSoftAmar;User ID=ali;Password=hamishebahar?3773284;Connect Timeout=15;Encrypt=False;Packet Size=4096")
        {
        }
#endif
