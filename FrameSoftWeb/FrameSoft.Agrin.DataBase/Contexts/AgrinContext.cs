...
namespace FrameSoft.Agrin.DataBase.Contexts
{
    ...
    {
        public AgrinContext()
              : base("data source=(LOCAL)\\SQLEXPRESS;initial catalog=FrameSoftAmar;User ID=Ali;Password=AVS?3773284HAMISHEBAHAR?2354;MultipleActiveResultSets=True;App=EntityFramework")
        {
