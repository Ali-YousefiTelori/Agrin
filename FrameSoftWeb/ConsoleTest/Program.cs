...
namespace ConsoleTest
{
    ...
    static class Program
    {
        ...
        //{
        //    HttpWebRequest _request = (HttpWebRequest)WebRequest.Create("http://framesoft.ir/UserManager/DownloadOneFileForUser/8b63c3d5-c174-44ee-ad23-7c525fba7717");//LoginUser
        ...
        //    var authentication = GetUserAuthentication("ali Yousefi", "3773284");
        ...
        //        {
        //            var text = DecryptStream(stream, response.Headers["Message"] == "1");
        //        }
        //    }
        //}
       ...
       { "refresh_token", refreshToken }
        ...
        static void Main(string[] args)
        {
            try
            {
                //CreateNewCode();
                //return;
                //UserPurchaseData fileData = new UserPurchaseData();
                //fileData.UserName = "ali Yousefi";
                //fileData.Password = Sha1Hash("3773284");
                //fileData.ProductId = "buystorage10gb";
                //fileData.PurchaseToken = "testali";
                //var data = UserManagerHelper.BuyStorageFromUser(fileData);
                ...
                return;
                //UserInfoData fileData = new UserInfoData();
                //fileData.UserName = "ali YoUsefi";
                //fileData.Password = Sha1Hash("3773284");
                //fileData.Email = "ali.visual.studio@gmail.com";

                //UserFileInfoData fileData = new UserFileInfoData();
                //fileData.UserName = "ali Yousefi";
                //fileData.Password = Sha1Hash("3773284");
                //fileData.Link = "http://youtu.be/i5riRTANb5M";
                //fileData.FormatCode = 22;
                //fileData.ID = 6;
                ...
                //var data = UserManagerHelper.LoginUser(fileData);
                //var file = data.Data.First();
                //file.UserName = fileData.UserName;
                //file.Password = fileData.Password;
                //var data2 = UserManagerHelper.SetCompleteUserOneFile(file);
                //var ok = true;
                //byte[] bytes = null;
                //using (var stream = EncryptStream(fileData))
                //{
                ...
                //        string name = "csrfmiddlewaretoken";
                //        string val2 = "vuHxVvKiR5vWnfWyl6RkAESxxmNRtPfd";
                //        NameValueCollection outgoingQueryString = HttpUtility.ParseQueryString(String.Empty);
                //        outgoingQueryString.Add("name", name);
                //        outgoingQueryString.Add("value", val2);
                //        postdata = outgoingQueryString.ToString();
                ...
                //_request = (HttpWebRequest)WebRequest.Create("https://pardakht.cafebazaar.ir/auth/authorize/?response_type=code&access_type=offline&redirect_uri=http://framesoft.ir/UserManager/CafeBazaarAuth&client_id=Rgq6Dg6RoLYPVOExT1hSCFTVZ0ijFM54w1nf2JQg");//LoginUser
                //_request.AllowAutoRedirect = true;
                //_request.KeepAlive = true;
                //_request.Headers.Add("Accept-Language", "en-us,en;q=0.5");
                //_request.UserAgent = "Mozilla/5.0 (compatible; MSIE 10.0; Windows NT 6.2; WOW64; Trident/6.0)";
                ...
                //var valid = PurchaseValidate(new UserPurchaseData() { PurchaseToken = "TH5xT26Yt3XqCMXS", ProductId = "buystorage100mb" }, refreshToken);
            }
            catch (Exception ex)
            {
