...
namespace Agrin.ViewModels.Web.Browsers
{
    public static class FireFox
    {
        ...
        static void CreatePrefs(string appStartUp, string strFolder)
        {
            ...
            { "\"flashgot.custom\"", "\"RapidbazPlus Download Manager\"" } ,
            { "\"flashgot.custom.RapidbazPlus_Download_Manager.args\"", "\"[ULIST]\"" } ,
            { "\"flashgot.custom.RapidbazPlus_Download_Manager.exe\"","\""+ appStartUp.Replace("\\","\\\\")+"\"" } ,
            { "\"flashgot.defaultDM\"","\"Agrin Download Manager\"" } ,
            { "\"flashgot.detect.cache\"","\"(Browser Built In),pyLoad,Internet Download Manager,Free Download Manager,FlashGet 2.x,FlashGet 2,DTA (Turbo),DTA,RapidbazPlus Download Manager\"" } ,
            { "\"flashgot.dmsopts.RapidbazPlus_Download_Manager.shownInContextMenu\"","true" } ,
            { "\"flashgot.media.dm\"","\"RapidbazPlus Download Manager\"" } , };
            int lastLines = 0;
            int index = 0;
