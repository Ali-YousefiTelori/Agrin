...
namespace Agrin.IO.File
{
    public class TestStream
    {
        ...
        {
            using(FileStream stream = new FileStream("d:\\text.apk",FileMode.Create,FileAccess.ReadWrite))
            {
        ...
        public void ReadFile(int length)
        {
            ...
            using (FileStream stream = new FileStream("d:\\text.apk", FileMode.Open, FileAccess.ReadWrite))
            {
