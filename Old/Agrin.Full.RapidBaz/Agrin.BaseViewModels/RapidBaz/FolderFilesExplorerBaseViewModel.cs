...
namespace Agrin.BaseViewModels.RapidBaz
{
    ...
    {
        public QueueListRapidBazBaseViewModel CurrentQueueListRapidBazBaseViewModel { get; set; }
        ...
        FastCollection<FolderInfo> _Items;
        public FastCollection<FolderInfo> Items
        {
            get
            {
                if (_Items == null)
                    _Items = new FastCollection<FolderInfo>(ApplicationHelperMono.DispatcherThread);
                return _Items;
            }
            set { _Items = value; }
        }
        ...
        //public void GetFolderFiles(FolderInfo folder, Action<List<RapidItemInfo>> complete)
        //{
        //    RapidTextStatus = "در حال بررسی...";
        //    IsBusy = true;
        //    AsyncActions.Action(() =>
