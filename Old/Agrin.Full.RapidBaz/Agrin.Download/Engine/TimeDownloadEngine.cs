    ...
    public static class TimeDownloadEngine
    {
                        ...
                        foreach (var item in downdingLinks)
                        {
                            if (item.DownloadingProperty.State == ConnectionState.Downloading)
                            {
                                ...
                                else if (size > 0)
                                {
                                    ...
                                    double newRate = downloadedSize - oldSizes[item];
                                    item.DownloadingProperty.ListSpeedByteDownloaded.Add(newRate);
                                    ...
                                    item.DownloadingProperty.SpeedByteDownloaded = average;
        ...
        public static void CheckLastVersion(bool userManual = false)
        {
            ...
            using (System.Net.WebClient client = new System.Net.WebClient())
            {
                ...
                client.Headers.Add("IsRapidBaz", "True");
