...
namespace Agrin.Download.Manager
{
    public class ApplicationLinkInfoManager
    {
        ...
        public FastCollection<LinkInfo> LinkInfoes
        {
            ...
            {
                if (_LinkInfoes == null)
                    _LinkInfoes = new FastCollection<LinkInfo>(ApplicationHelperMono.DispatcherThread);
                return _LinkInfoes;
            }
        ...
        public FastCollection<LinkInfo> DownloadingLinkInfoes
        {
            get
            {
                if (_DownloadingLinkInfoes == null)
                    _DownloadingLinkInfoes = new FastCollection<LinkInfo>(ApplicationHelperMono.DispatcherThread);
        ...
        public void DeleteRangeLinkInfo(List<LinkInfo> linkInfoes, bool isDeleteFromDisk = false)
        {
            ...
            foreach (var item in linkInfoes)
            {
                ...
                if (isDeleteFromDisk)
                {
                    ...
                    {
                        AutoLogger.LogError(e, "isDeleteFromDisk", true);
                    }
                }
            }
