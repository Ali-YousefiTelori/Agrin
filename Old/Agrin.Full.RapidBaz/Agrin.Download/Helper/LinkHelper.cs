...
namespace Agrin.Download.Helper
{
    ...
    public static class LinkHelper
    {
        ...
        {
            var report = SerializeStream.OpenSerializeStream(fileName) as LinkInfoReport;
            ...
            if (!System.IO.Directory.Exists(path))
            {
                ...
                foreach (var file in report.Files)
                {
                    ...
                    using (System.IO.FileStream copystream = new System.IO.FileStream(fileN, System.IO.FileMode.OpenOrCreate, System.IO.FileAccess.ReadWrite))
                    {
        ...
        public static void AddRange(long range, HttpWebRequest _request)
        {
