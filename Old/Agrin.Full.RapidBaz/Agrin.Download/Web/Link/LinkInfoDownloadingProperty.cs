...
namespace Agrin.Download.Web.Link
{
    public class LinkInfoDownloadingProperty : ANotifyPropertyChanged
    {
        ...
        List<double> _ListSpeedByteDownloaded = new List<double>();

        public List<double> ListSpeedByteDownloaded
        {
        ...
        public string GetPercent
        {
            get
            {
                return Size < 0 ? ApplicationHelperMono.GetAppResource("Unknown_Language", true) : String.Format("{0:00.00%}", (double)DownloadedSize / Size);
            }
        }
        /// <summary>
        /// لینک اصلی
