    ...
    public class LinkCheckTest
    {
        ...
        public void TestRequestHttp()
        {
            try
            {
                ...
                var uri = new Uri(HttpUtility.UrlDecode("http://framesoft.dl.rapidbaz.com/I2qJ./%282%29+Dreamworld+-+Leo+Rojas+-+El+Condor+Pasa.mp4"));
                //string uri = ;
                // while (true)
                //{
        ...
        public void TestLinkHttp()
        {
            try
            {
               // string link = "http://dl.asramusic125.org/persian%20full%20video/Yas/Yas%20-%20Az%20Chi%20Begam%20%28%20AsraMusic%20%29.mp4";
                ...
                string link = "http://youtu.be/i5riRTANb5M";
                var pp = Assembly.GetExecutingAssembly().Location;
                var videos = Agrin.LinkExtractor.DownloadUrlResolver.GetDownloadUrls(link);
