...
namespace Agrin.Views.Web
{
    ...
    public class AgrinBrowser : IDisposable
    {
        ...
        public WebView currentWebView = null;
        ...
        public void InitWebView(WebView webView)
        {
            ...
            try
            {
                ...
                if (ViewsUtility.GetApiVersion() >= 11)
                {
                ...
                else
                {
                    ZoomButtonsController zoom_controll =
                        (ZoomButtonsController)webView.GetType().GetMethod("getZoomButtonsController").Invoke(webView, null);
                    zoom_controll.Container.Visibility = ViewStates.Gone;
                }
            }
        ...
        public bool IsFocusOnAgrinBrowser()
        {
            if (_mainLayout.ChildCount > 0 && _mainLayout.GetChildAt(0) == _CustomView)
                return true;
            return false;
