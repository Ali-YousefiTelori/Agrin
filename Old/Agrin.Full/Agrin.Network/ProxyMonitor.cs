    ...
    public static class ProxyMonitor
    {
        ...
        public static void Start()
        {
            if (Fiddler.FiddlerApplication.IsStarted())
                return;
            //Fiddler.FiddlerApplication.BeforeRequest -= FiddlerApplication_AfterSessionComplete;
            //Fiddler.FiddlerApplication.BeforeRequest += FiddlerApplication_AfterSessionComplete;
        ...
        static void FiddlerApplication_BeforeResponse(Fiddler.Session session)
        {
            ...
            //    //String oBody = System.Text.Encoding.UTF8.GetString(session.responseBodyBytes);
            //    //oBody = oBody.Replace("<body>", "<body><script src='a.js' type='text/javascript'/>");
            //    session.utilSetResponseBody("<html><body>Agrin<body/><html/>");
            //    //String oBody = System.Text.Encoding.UTF8.GetString(session.responseBodyBytes);
            //    //session.utilDecodeResponse();
            //    //String oBody = System.Text.Encoding.UTF8.GetString(session.responseBodyBytes);
            //    //oBody = oBody.Replace("<body>", "<body><script src='a.js' type='text/javascript'/>");
            //    //session.utilSetResponseBody("Arin");
            //}
            //catch
            //{
...
//                        if (body == null)
//                            return;
//                        if (body.ToLower().Contains("<head>"))
//                        {
//                            string replaceStyle = @"<style>
//.agrin-dropdown-content {
//    display: none;
//    position: absolute;
...
//.agrin-dropdown-content .AgrinATag {
//    color: black;
//    padding: 12px 16px;
...
//z-index: -100;
//}
//.agrin-dropdown-content .AgrinATag:hover {background-color: #f1f1f1}
...
//function AgrinShowMenu() {
//    document.getElementById(""agrinDropdown"").classList.toggle(""show"");
//}

//// Close the dropdown if the user clicks outside of it
//window.onclick = function(e) {
//  if (!e.target.matches('.agrinDropbtnClass')) {

//    var dropdowns = document.getElementsByClassName(""agrin-dropdown-content"");
...
// var items = document.getElementsByClassName(""g-button"");
//for (i = 0; i < items.length; i++) {
//    findElement = items[i];//document.getElementById(""theParent"");
//	attribV=findElement.getAttribute(""href"");
//	if (attribV !=null && attribV.includes("".MkvCage.rar""))
//	{
//alert(""find ok"");
//		var theParent = document.createElement(""a"");
//	theParent.setAttribute(""class"", ""agrinDropbtnClass"");
//	theParent.setAttribute(""onclick"", ""AgrinShowMenu()"");
//	findElement.parentNode.replaceChild(theParent, findElement);
//	theParent.innerHTML=findElement.innerHTML;
//	theKid = document.createElement(""div"");
	
//	theKid.setAttribute(""class"", ""agrin-dropdown-content"");
//	theKid.setAttribute(""id"", ""agrinDropdown"");
//	theKid.innerHTML = '<a class=""AgrinATag"" id=""AgrinLinkToBrowser"" href=""#"">Open From Browser</a><a class=""AgrinATag"" id=""AgrinLinkToApp"" href=""#"">Open From Agrin</a>';
...
//                            var start = body.Substring(0, index);
//                            var end = body.Substring(index, body.Length - index);
//                            var middle = replaceStyle + replaceScript ;
...
//                        }
                ...
                //String oBody = System.Text.Encoding.UTF8.GetString(session.responseBodyBytes);
                session.ResponseHeaders["AgrinResponseToDownload"] = "ok";
                //session.ResponseHeaders["Connection"] = "keep-alive";
                //session.ResponseHeaders["Content-Length"] = "40";
                //session.ResponseHeaders["Vary"] = "Accept-Encoding";
                //session.ResponseHeaders["Content-Encoding"] = "gzip";
