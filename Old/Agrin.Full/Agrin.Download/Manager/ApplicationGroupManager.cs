...
namespace Agrin.Download.Manager
{
    public class ApplicationGroupManager
    {
        ...
        GroupInfo _NoGroup = new GroupInfo() { Name = "بدون گروه", Id = 0 };
        ...
        public FastCollection<GroupInfo> GroupInfoes
        {
            get
            {
                if (_GroupInfoes == null)
                    _GroupInfoes = new FastCollection<GroupInfo>(ApplicationHelperBase.DispatcherThread);
                return _GroupInfoes;
            }
        ...
        public GroupInfo FindGroupByFileName(string fileName)
        {
            ...
            string ext = MPath.GetFileExtention(fileName);
