...
namespace Agrin.IO.Strings
{
    public static class HtmlPage
    {
        ...
        public static List<string> ExtractLinksFromHtml(string html)
        {
            ...
            {
                Agrin.Log.AutoLogger.LogError(e, "ExtractLinksFromHtml", true);
        ...
        public static List<string> ExtractLinksFromHtmlTwo(string html)
        {
            try
            {
                html = Agrin.IO.Strings.Decodings.UrlDecode(html);
                Regex r;
                Match m;
            ...
            {
                Agrin.Log.AutoLogger.LogError(e, "ExtractLinksFromHtmlTwo", true);
