...
namespace Agrin.Mono.UI
{
	public partial class AddLinks
	{
		...
		protected virtual void Build ()
		{
			...
			this.btnsave.WidthRequest = 32;
			this.btnsave.HeightRequest = 32;
			this.btnsave.CanFocus = true;
			this.btnsave.Name = "btnsave";
			this.btnsave.UseUnderline = true;
			global::Gtk.Image w7 = new global::Gtk.Image ();
			this.btnsave.Image = w7;
			this.hbox5.Add (this.btnsave);
			global::Gtk.Box.BoxChild w8 = ((global::Gtk.Box.BoxChild)(this.hbox5 [this.btnsave]));
			w8.Position = 0;
			w8.Expand = false;
			w8.Fill = false;
			// Container child hbox5.Gtk.Box+BoxChild
			...
			this.btnAdd.WidthRequest = 32;
			this.btnAdd.HeightRequest = 32;
			...
			this.btnPlay.WidthRequest = 32;
			this.btnPlay.HeightRequest = 32;
			...
			this.Hide ();
			this.btnsave.Clicked += new global::System.EventHandler (this.OnButton16Clicked);
