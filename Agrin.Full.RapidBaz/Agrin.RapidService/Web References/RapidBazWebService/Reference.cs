...
namespace Agrin.RapidService.RapidBazWebService {
    using System;
    ...
    public partial class WSDLapiwebService : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        private System.Threading.SendOrPostCallback RetryOperationCompleted;
        ...
        public WSDLapiwebService() {
            this.Url = global::Agrin.RapidService.Properties.Settings.Default.Agrin_RapidService_RapidBazWebService_WSDLapiwebService;
        ...
        /// <remarks/>
        public event RetryCompletedEventHandler RetryCompleted;
        ...
        public string Get(string session1, string limit1, string from1, string name1) {
        ...
        /// <remarks/>
        public void GetAsync(string session1, string limit1, string from1, string name1) {
            this.GetAsync(session1, limit1, from1, name1, null);
        }
        
        /// <remarks/>
        public void GetAsync(string session1, string limit1, string from1, string name1, object userState) {
            ...
            this.InvokeAsync("Get", new object[] {
                        ...
                        limit1,
                        from1,
                        name1}, this.GetOperationCompleted, userState);
        }
        ...
        /// <remarks/>
        [System.Web.Services.Protocols.SoapRpcMethodAttribute("urn:apiwebAction", RequestNamespace="urn:WSDLapiweb", ResponseNamespace="urn:WSDLapiweb")]
        [return: System.Xml.Serialization.SoapElementAttribute("RetryReturn")]
        public string Retry(string session1, string qid1) {
            object[] results = this.Invoke("Retry", new object[] {
                        session1,
                        qid1});
            return ((string)(results[0]));
        }
        ...
        /// <remarks/>
        public void RetryAsync(string session1, string qid1) {
            this.RetryAsync(session1, qid1, null);
        }
        
        /// <remarks/>
        public void RetryAsync(string session1, string qid1, object userState) {
            if ((this.RetryOperationCompleted == null)) {
                this.RetryOperationCompleted = new System.Threading.SendOrPostCallback(this.OnRetryOperationCompleted);
            }
            this.InvokeAsync("Retry", new object[] {
                        session1,
                        qid1}, this.RetryOperationCompleted, userState);
        }
        
        private void OnRetryOperationCompleted(object arg) {
            if ((this.RetryCompleted != null)) {
                System.Web.Services.Protocols.InvokeCompletedEventArgs invokeArgs = ((System.Web.Services.Protocols.InvokeCompletedEventArgs)(arg));
                this.RetryCompleted(this, new RetryCompletedEventArgs(invokeArgs.Results, invokeArgs.Error, invokeArgs.Cancelled, invokeArgs.UserState));
            }
        }
    ...
    /// <remarks/>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "4.0.30319.34209")]
    public delegate void RetryCompletedEventHandler(object sender, RetryCompletedEventArgs e);
    
    /// <remarks/>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "4.0.30319.34209")]
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    public partial class RetryCompletedEventArgs : System.ComponentModel.AsyncCompletedEventArgs {
        
        private object[] results;
        
        internal RetryCompletedEventArgs(object[] results, System.Exception exception, bool cancelled, object userState) : 
                base(exception, cancelled, userState) {
            this.results = results;
        }
