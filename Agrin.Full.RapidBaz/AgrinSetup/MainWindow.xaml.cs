...
namespace AgrinSetup
{
    ...
    public partial class MainWindow : Window
    {
            ...
            System.Threading.Thread thread = new System.Threading.Thread(() =>
                {
                    ...
                    try
                    {
                        ...
                        {"Agrin_RapidService","Agrin.RapidService.dll"} ,{"Agrin_RapidService_XmlSerializers","Agrin.RapidService.XmlSerializers.dll"},
                        ...
                        {"Agrin_RapidBaz","Agrin.RapidBaz.dll"},{"Agrin_ViewModels","Agrin.ViewModels.dll"},{"Microsoft_Windows_Shell","Microsoft.Windows.Shell.dll"}};
        ...
        private void btnDownloadFlashGot_Click(object sender, RoutedEventArgs e)
        {
            ...
            SetFlashGotMessage("لطفاً منتظر بمانید تا مرورگر برای دانلود و نصب اجرا شود.");
        }
