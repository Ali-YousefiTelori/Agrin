        ...
        static void Main(string[] args)
        {
            try
            {
                try
                {
                    ...
                    HttpWebRequest _request = (HttpWebRequest)WebRequest.Create("http://vip1.serverdl.xyz/index.php?filename=Movies/PRNYAB/Bz/2017/04/24/%40PRNYAB%20-%20btas_jessa_rhodes_vl041117_480p_1000.mp4");
                ...
                //var loginData = Agrin.Framesoft.Helper.UserManagerHelper.LoginUser(new Agrin.Framesoft.UserInfoData() { UserName = "ali yousefi", Password = "3773284".Sha1Hash(), ApplicationGuid = guid });
                ...
                //var list = Agrin.Framesoft.Helper.UserManagerHelper.GetYoutubeVideoList(new Agrin.Framesoft.UserFileInfoData() { UserName = "ali yousefi", Password = "3773284".Sha1Hash(), Link = "http://youtu.be/fSeKW_yloKM" });
