...
namespace Agrin.LinkExtractor
{
    public class VideoInfo
    {
        internal static IEnumerable<VideoInfo> Defaults = new List<VideoInfo>
        {
            ...
            new VideoInfo(139, VideoType.M4A, 0, false, AudioType.Aac, 48, AdaptiveType.Audio),
            new VideoInfo(140, VideoType.M4A, 0, false, AudioType.Aac, 128, AdaptiveType.Audio),
            new VideoInfo(141, VideoType.M4A, 0, false, AudioType.Aac, 256, AdaptiveType.Audio),
            ...
            new VideoInfo(249, VideoType.WebM, 0, false, AudioType.Mp3, 50, AdaptiveType.Audio),
            new VideoInfo(250, VideoType.WebM, 0, false, AudioType.Mp3, 70, AdaptiveType.Audio),
            new VideoInfo(251, VideoType.WebM, 0, false, AudioType.Mp3, 160, AdaptiveType.Audio)
        };
