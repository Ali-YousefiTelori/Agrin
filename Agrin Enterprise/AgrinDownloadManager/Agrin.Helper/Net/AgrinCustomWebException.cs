...
namespace Agrin.Helper.Net
{
    public class AgrinCustomWebException
    {
        public static AgrinCustomWebException ExceptionToSerializable(Exception e)
        {
            if (e is WebException)
            {
                ...
                return new AgrinCustomWebException() { ExceptionData = e, OtherData = data, CreatedDateTime = DateTime.Now };
            }
            return new AgrinCustomWebException() { ExceptionData = e, CreatedDateTime = DateTime.Now };
        }
