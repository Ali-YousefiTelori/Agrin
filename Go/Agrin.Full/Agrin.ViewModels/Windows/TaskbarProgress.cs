...
namespace Agrin.ViewModels.Windows
{
    ...
    public static class TaskbarProgress
    {
        ...
        public static TaskbarItemInfo TaskbarItem { get; set; } = new TaskbarItemInfo();
        ...
        public static void SetState(TaskbarItemProgressState taskbarState)
        {
            if (TaskbarSupported && MainWindow != null)
            {
                MainWindow.Dispatcher.BeginInvoke(new Action(() =>
                {
                    TaskbarItem.ProgressState = taskbarState;
                    int i = 0;
                }));
            }
        ...
        public static void SetValue(double progressValue, double progressMax)
        {
            if (TaskbarSupported && MainWindow != null)
            {
                ...
                MainWindow.Dispatcher.BeginInvoke(new Action(() =>
                {
                    TaskbarItem.ProgressValue = value / 100;
                }));
            }
